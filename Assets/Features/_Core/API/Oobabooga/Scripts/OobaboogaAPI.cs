...
namespace Features._Core.API.Oobabooga.Scripts
{
    ...
    public class OobaboogaAPI
    {
        ...
        /// https://github.com/oobabooga/text-generation-webui/wiki/03-‐-Parameters-Tab
        /// </summary>
        public async Task<(APIResponse Response, List<ChatCompletionResponse> Data)> CreateChatCompletion(ChatCompletionRequestContainer chatCompletionRequestContainer)
        {
